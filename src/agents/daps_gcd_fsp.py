...
# LLM+P with Domain-and-Problem-specific Grammar Constrained Decoding (constraints over predicates, types and objects) and Few-Shot Prompting
def get_problem_pddl_daps_gcd_fsp(problem_nl: str, 
                     domain: str, 
                     api_key: str, 
                     model: str):
