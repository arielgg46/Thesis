...
def eval_trial(task: dict, modeling_agent_resp):
    ...
    parseable, solvable, correct = evaluate_pddl(domain, pddl_gt, pddl_pred, task["is_placeholder"])
    ...
    if parseable and not solvable:
        ...
        init2_parseable, init2_solvable, _ = evaluate_pddl(domain, init2_pddl, init2_pddl, task["is_placeholder"])
        goal2_parseable, goal2_solvable, _ = evaluate_pddl(domain, goal2_pddl, goal2_pddl, task["is_placeholder"])
        # print(init2_pddl)
        # print(goal2_pddl)
    ...
    if parseable and solvable and not correct:
        ...
        _, _, init2_correct = evaluate_pddl(domain, init2_pddl_gt, init2_pddl_pred, task["is_placeholder"])
        _, _, goal2_correct = evaluate_pddl(domain, goal2_pddl_gt, goal2_pddl_pred, task["is_placeholder"])
