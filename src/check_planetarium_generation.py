...
DATASET_PATH = os.path.join(BASE_DIR, "dataset", "dataset-v4.db")
...
def save_subsets():
    train_df = select_and_save_planetarium_subset_sql(DATASET_PATH, train_pairs, 1, "train3")
    test_df = select_and_save_planetarium_subset_sql(DATASET_PATH, test_pairs, 1, "test3")
    return train_df, test_df

train_df, test_df = save_subsets()
