...
"""
        ...
        if self.use_gcd and not self.use_daps:
            ...
            if len(self.domain_types) == 0:
                ...
                pddl_problem_grammar = get_pddl_problem_grammar_daps_typing(self.domain, self.domain + "_problem", self.domain_predicates, objects, self.domain_types)
        else:
